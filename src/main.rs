...
fn main() {
    ...
    assert_eq!(
        ...
        [
            Particle {
                mass: 15.0,
                speed: Coordinates([-0.6309910380664001, -1.8054294207312598]),
                position: Coordinates([-131.04483937204387, -426.65005151876125])
            },
            Particle {
                mass: 10.0,
                speed: Coordinates([0.6780727901268769, 2.2440584293094075]),
                position: Coordinates([59.958335444060374, 189.0186798571582])
            },
            Particle {
                mass: 10.0,
                speed: Coordinates([0.26841376697272246, 0.4640857017874784]),
                position: Coordinates([286.6089236140069, 400.95639742098393])
            }
        ]
    )
}
